...
const initProxy = async () => {
    try {
        let data = await getApi("http://webapi.http.zhimacangku.com/getip?num=1&type=2&pro=&city=0&yys=0&port=11&pack=38704&ts=1&ys=1&cs=1&lb=1&sb=0&pb=4&mr=1&regions=")
        proxy = data.data[0]
